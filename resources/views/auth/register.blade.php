<x-guest-layout>
    ...
    <!-- Name -->
        ...
        <div class="flex items-center justify-end mt-4">
            <a class="underline text-sm text-zinc-400 hover:text-zinc-200 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-700" href="{{ route('login') }}">
